...
The CollabSeer system recommends collaborators for a researcher based on the co-authorship network, which a an open system introduced by Chen et al. considering the co-author network and research interests for collaborators. Ma et al. analysed how social networks information can benefit recommender systems and proposed a method improving the performance of recommender systems by incorporating social network information.
