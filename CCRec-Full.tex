...
% -----------------------------------------------------------------------------
In this work, we clustered 500 topics based on DBLP data set and matched researchers to different domains. Here we studied the statistics of these domains. As described in Fig. 5, in terms of the number of researches in each domain, there are about 56 domains that contain up to 100 researchers, and two domains contain more than 2500 researchers. We can come to the conclusion that, various domains show large differences in scales, most of the domains keep scale no more than 1000 researchers. What's more, as shown in Fig. 5(b), most researchers are active in 2 to 20 domains. However, there is no clear standard to make the domains division. The statistics shows changeful with different clustering granularity. In this section, we exploit the impact of clustered domains number on the performance of CCRec.

\begin{figure*}
\centering
\subfigure[Number of researchers in each domain]{
\label{fig:5-a}
\includegraphics[width=0.48\textwidth]{Fig5-a.eps}}
\subfigure[Number of domains each researcher in]{
\label{fig:5-b}
\includegraphics[width=0.48\textwidth]{Fig5-b.eps}}
